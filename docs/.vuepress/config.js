...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'fengrenyi', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'Fry', // 必需
      link: 'https://github.com/fengrenyi' // 可选的
    },
    blogger:{ // 博主信息，显示在首页侧边栏
      avatar: '/img/head.jpg',
      name: 'Fry',
      slogan: '世界那么大，总有停留的地方'
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:369785018@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/fengrenyi'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'fengrenyi | <a href="https://github.com/fengrenyi" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
